						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="ProfilePhoto" type="text" placeholder="Enter ProfilePhoto" v-model="userToAdd.profilePhoto"></base-input>
												                  </form>
								                </div>
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Password</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Profile Photo</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="ProfilePhoto" type="text" placeholder="Enter ProfilePhoto" v-model="userDetails.profilePhoto"></input>
																		</div>
						</td>
														</tr>
